...
const NEIGHBORHOODS = {
    'kalamaria': {
        name: 'Καλαμαριά',
        slug: 'kalamaria',
        description: 'Αναζητάτε αξιόπιστο ηλεκτρολόγο στην Καλαμαριά; Βρείτε τους καλύτερους επαγγελματίες της περιοχής με επαληθευμένες κριτικές και ανταγωνιστικές τιμές. Άμεση εξυπηρέτηση και 24ωρη κάλυψη.',
    ...
    'neapoli': {
        name: 'Νεάπολη',
        slug: 'neapoli',
        description: 'Ηλεκτρολόγοι στη Νεάπολη Θεσσαλονίκης με επαληθευμένες κριτικές. Εξειδικευμένοι σε επισκευές, εγκαταστάσεις και συντήρηση. Καλέστε τώρα για δωρεάν προσφορά.',
